  ...
  return (
    <div className="border-2 border-white bg-white p-4 text-black">
      ...
      <p className="mt-1 text-xs">
        Current default price is {formatUnits(currentPrice ?? 0n, USDC_DECIMALS)} USDC
      ...
      <p className="mt-2 text-xs">
        {isOwner
          ? "Click below to update the contract default price."
          : "Only the contract owner can update the price. Connect with the owner wallet."}
      </p>
      <button
        onClick={() => {
